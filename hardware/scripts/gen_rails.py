...
place("L4", "Device:L", "22uH", 107.95, 30.48, 90, TWOPIN,
      [("Reference", "L4", 109.22, 26.67, 90), ("Value", "22uH", 111.76, 34.29, 90)], npins=2)
...
place("L5", "Device:L", "22uH", 107.95, 76.2, 90, TWOPIN,
      [("Reference", "L5", 109.22, 72.39, 90), ("Value", "22uH", 111.76, 80.01, 90)], npins=2)
