...
| `infineon_ipt008n06nm5lf_datasheet_en.pdf` | Infineon IPT008N06NM5LF | **SELECTED** - the back-to-back pass FETs for the LTC4380 (2 required) | **Rev. 2.1, 2022-09-19.** OptiMOS 5 **LinearFET**, 60 V. Feature list opens 'Ideal for hot-swap and e-fuse applications' and 'Wide safe operating area SOA' - built for this job. **0.67 mOhm typ / 0.8 mOhm max at VGS=10V** against a 5 mOhm target; VGS +-20 V; 48 A on the theta-JA line. **Diagram 3 (SOA) carries 1us-10ms AND a DC line; the 10 ms line at 12 V reads ~50 A against a 7 A need.** Takes the night budget to ~2.31 W and the board to ~60 C - cooler than it is today. Two caveats recorded, neither blocking: **JEDEC Industrial, NOT AEC-Q101**, and PG-HSOF-8 (TOLL) is ~9.9 x 10.5 mm. See part-selection.md. |
